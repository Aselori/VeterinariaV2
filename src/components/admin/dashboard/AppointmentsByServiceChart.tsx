...
export default function AppointmentsByServiceChart({ data, isDark }: Props) {
    ...
    <ResponsiveContainer width="100%" height={220}>
      <BarChart data={data} margin={{ top: 4, right: 8, left: -20, bottom: 4 }}>
        ...
        <Tooltip
          ...
          cursor={{ fill: isDark ? '#334155' : '#ffecc8' }}
        />
        <Bar dataKey="value" name="Citas" fill="#FFD09B" radius={[6, 6, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  )
}
